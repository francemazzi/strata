(function () {
  ...
  const translations = {
    it: {
      ...
      "theater.identify": "Identifica",
      "theater.buffer": "Buffer",
      "theater.popup": "Ferrara · 12,4 ha",
      "theater.window": "Buffer 200 m sui vincoli, poi export GeoJSON.",
      "theater.run": "Esegui",
      "theater.wait": "In attesa",
      "theater.working": "In corso…",
      "theater.done": "Fatto",
      "theater.ask": "Quali vincoli per Acme?",
      "theater.bubble.2": "Piano Q3 già in knowledge. Firmano solo annuale.",
      "theater.pin.rule": "rule · vincoli",
      "theater.pin.skill": "skill · acme",
      "theater.pill.1": "Rilievo",
      "theater.pill.2": "Export",
      "theater.pill.3": "Gallery",
      "theater.launch": "Avvia",
      "theater.running": "in corso",
      "theater.sync": "3 agenti in parallelo",
      "theater.cursor.analisi": "Analisi",
      "theater.cursor.routine": "Routine",
      "theater.cursor.contesto": "Contesto",
      "theater.cursor.team": "Team",
    ...
    en: {
      ...
      "theater.chip": "layer · comuni",
      "theater.identify": "Identify",
      "theater.buffer": "Buffer",
      "theater.popup": "Ferrara · 12.4 ha",
      "theater.window": "200 m buffer on constraints, then GeoJSON export.",
      "theater.run": "Run",
      "theater.wait": "Idle",
      "theater.working": "Working…",
      "theater.done": "Done",
      "theater.ask": "Which constraints for Acme?",
      "theater.bubble.2": "Q3 plan is already in knowledge. They only sign yearly.",
      "theater.pin.rule": "rule · constraints",
      "theater.pin.skill": "skill · acme",
      "theater.pill.1": "Survey",
      "theater.pill.2": "Export",
      "theater.pill.3": "Gallery",
      "theater.launch": "Start",
      "theater.running": "running",
      "theater.sync": "3 agents in parallel",
      "theater.cursor.analisi": "Analysis",
      "theater.cursor.routine": "Routine",
      "theater.cursor.contesto": "Context",
      "theater.cursor.team": "Team",
